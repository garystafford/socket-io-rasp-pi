...
${OBJECTDIR}/_ext/1087642832/client.o: ../../Documents/SocketIO/client.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1087642832/client.o ../../Documents/SocketIO/client.c

${OBJECTDIR}/_ext/1087642832/server.o: ../../Documents/SocketIO/server.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1087642832
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1087642832/server.o ../../Documents/SocketIO/server.c
